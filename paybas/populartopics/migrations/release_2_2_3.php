...
class release_2_2_3 extends \phpbb\db\migration\migration
{
	...
	{
		return isset($this->config['pt_version']) && version_compare($this->config['pt_version'], '2.2.3', '>=');
	}

	static public function depends_on()
	{
		return array(
			'\paybas\populartopics\migrations\release_2_2_2',
		);
	}
	...
	{
		return array(
			array('config.update', array('pt_version', '2.2.3')),
		);
	}
}
